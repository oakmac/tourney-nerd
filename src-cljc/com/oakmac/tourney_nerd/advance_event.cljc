...
(defn advance-pending-group-result
  ...
  (let [pending-game-id (:game-id pending-game)
        ...
        group1-finished? (and (seq group1-games) (every? games/game-finished? (vals group1-games)))
        group2-finished? (and (seq group2-games) (every? games/game-finished? (vals group2-games)))
        ...
        group1-tiebreaking-method (results/group->tiebreaking-method event group1-id)
        group2-tiebreaking-method (results/group->tiebreaking-method event group2-id)
        group1-results (when group1-finished? (results/games->sorted-results group1-teams group1-games group1-tiebreaking-method))
        group2-results (when group2-finished? (results/games->sorted-results group2-teams group2-games group2-tiebreaking-method))
